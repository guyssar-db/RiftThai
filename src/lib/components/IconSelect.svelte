...
<div class="relative z-[130] min-w-0 lg:min-w-[180px]">
	<button
		type="button"
	...
	{#if isOpen && !disabled}
		<div
			class="absolute right-0 top-full z-[1000] mt-2 max-h-80 w-full min-w-56 overflow-y-auto rounded-2xl border border-white/10 bg-slate-950/95 p-2 shadow-2xl shadow-black/60 backdrop-blur-2xl"
			role="listbox"
			tabindex="-1"
		>

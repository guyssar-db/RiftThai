<script lang="ts">
    ...
    const mechanics: Record<string, string> = {
        'Ready': 'Ready (ตั้งตรง): ยูนิตพร้อมสามารถเคลื่อนย้าย (move) หรือใช้สกิลที่ต้องให้ Exhaust (นอนตะแคง) ได้',
        'Exhausted': 'Exhausted (นอนตะแคง): ยูนิตไม่สามารถเคลื่อนย้าย (move) หรือใช้สกิลที่ต้องให้ Exhaust (นอนตะแคง) ได้',
